<template>
  <div class="fixed bottom-4 right-4 z-50 space-y-2 pointer-events-none md:bottom-6 md:right-6">
    <transition-group name="toast" tag="div">
      <div
        ...
        :class="{
          ...
          'rounded-lg px-4 py-3 text-sm font-medium shadow-lg backdrop-blur-sm max-w-sm': true
        }"
      >
