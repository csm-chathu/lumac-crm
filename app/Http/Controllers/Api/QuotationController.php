...
class QuotationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $quote = DB::transaction(function () use ($request, $data, $customer) {
            $isAgent = $request->user()->role === 'agent' && ! $request->user()->is_admin;
            ...
            $quote->auditLogs()->create([
                'user_id' => $request->user()->id,
                'action' => 'created',
                'remarks' => 'Quotation generated by agent.',
                'meta' => [
                    'discount_rate' => $discountRate,
                    'commission_rate' => $commissionRate,
                ],
    ...
    {
        abort_if($quotation->user_id !== $request->user()->id, 403);
